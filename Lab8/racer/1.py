...
background = pygame.image.load('Lab8/resources/AnimatedStreet.png')
...
player_img = pygame.image.load('Lab8/resources/Player.png')
enemy_img = pygame.image.load('Lab8/resources/Enemy.png')

background_music = pygame.mixer.music.load('Lab8/resources/background.wav')
crash_sound = pygame.mixer.Sound('Lab8/resources/crash.wav')
